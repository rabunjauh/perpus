...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2020 at 04:30 PM
...
INSERT INTO `setting` (`idsetting`, `nama_sekolah`, `alamat`, `logo`, `email`, `settingcol`, `lama_pinjam`, `jumlah_max`, `denda`, `perpanjangan`) VALUES
(1, 'Sekolah A', 'Jl. Abc', NULL, 'sekolaha@google.com', NULL, 3, 3, 5000, 0);
...
--
ALTER TABLE `detail_inventory`
  MODIFY `id_detail_inventory` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `stock_buku`
  MODIFY `id_stock_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `detail_inventory`
  ADD CONSTRAINT `detail_inventory_ibfk_1` FOREIGN KEY (`id_inventory`) REFERENCES `inventory` (`id_inventory`),
